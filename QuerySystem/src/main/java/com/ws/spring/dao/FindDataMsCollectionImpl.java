 ...
 */
public class FindDataMsCollectionImpl implements FindDataDao {
    ...
    @Override
    public MSColledtionModel findDataBySdbsno(int sdbsno, String collectionName) {
        System.out.println("通过sdbsno进行查询");
        return mongoTemplate.findOne(new Query(Criteria.where("sdbsno").is(sdbsno)),MSColledtionModel.class,collectionName);
    }
