 ...
 */
@Repository
public class FindDataIrCollectionImpl2 implements FindDataDao {
    ...
    @Override
    public IRCollectionModel2 findDataBySdbsno(int sdbsno, String collectionName) {
        System.out.println("通过sdbsno进行查询");
        return mongoTemplate.findOne(new Query(Criteria.where("sdbsno").is(sdbsno)),IRCollectionModel2.class,collectionName);
    }
