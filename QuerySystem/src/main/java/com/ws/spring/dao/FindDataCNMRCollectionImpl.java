 ...
 */
public class FindDataCNMRCollectionImpl implements FindDataDao {
    ...
    public CNMRCollectionModel findDataBySdbsno(int sdbsno, String collectionName) {
        ...
        return mongoTemplate.findOne(new Query(Criteria.where("sdbsno").is(sdbsno)),CNMRCollectionModel.class,collectionName);
    }
